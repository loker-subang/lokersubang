<x-layout>
    <section class=dark:bg-gray-900">
        ...
        <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-4lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">LOKER
                    SUBANG</h2>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 ">
                @forelse ($data as $d)
                    <x-post category="{{ $d->category->name }}" date="{{ $d->created_at->format('d M Y') }}"
