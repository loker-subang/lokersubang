...
<head>
    ...
    <meta itemprop="name" content="{{ $title ?? 'Loker Subang - Lowongan Kerja Subang & Sekitarnya Terupdate 2026' }}">
    ...
    <meta itemprop="image" content="{{ isset($image) ? asset('storage/' . $image) : asset('img/logo.webp') }}">
    ...
    <meta property="og:image" content="{{ isset($image) ? asset('storage/' . $image) : asset('img/logo.webp') }}">
    ...
    <meta name="twitter:image" content="{{ isset($image) ? asset('storage/' . $image) : asset('img/logo.webp') }}">
