<x-layout title="{{ $post->title }}" desc="{{ $post->description }}" keyword="{{ $post->title }}" image="{{ $post->image }}">
                        ...
                        <ol class="inline-flex items-center space-x-2 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="/kategori/{{ $post->category->slug }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ $post->category->name }}</a>
                                </div>
                            </li>
